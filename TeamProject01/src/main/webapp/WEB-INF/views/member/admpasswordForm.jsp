						...
						<div id="content">
							<div class="post">
								<div class="entry">
									...
									<h1>암호변경</h1>
									<div id="comment_form">
									<form action="admpasswordChange.do" method="post">
										이메일: <input type="text" name="email" value="${email}" readonly><br>
									...
									<a href="update.do?email=${email}">[이전]</a> <a href="list.do">[목록]</a>
									</p>
								</div>
							</div>
						</div>
