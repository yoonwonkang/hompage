						...
						<div id="content">
							<div class="post">
								<div class="entry">
									...
									<h1>암호변경</h1>
									<div id="comment_form">
									<form action="myInfopasswordControl.do" method="post">
										이메일: <input type="text" name="email" value="${myInfo.email}"
											readonly><br> 이전 암호: <input type="password"
											name="password" required><br> 새 암호: <input
											type="password" name="newPassword" required><br>
										새 암호 확인: <input type="password" name="newPassword2" required><br>
										<input type="submit" value="변경">
									</form>
									</div>
										<a href="updateMyInfo.do">[이전]</a> <a href="../main.do">[메인]</a>
										</p>
								</div>
							</div>
						</div>
